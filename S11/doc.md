...
| specialty_ids | Обязательно | Массив целых | Каждый ID должен существовать в таблице Specialty, массив не пустой | — |

Параметры name и code уникальны по отдельности. Дисциплина может быть привязана к одной или нескольким специальностям через specialty_ids. 
