...
| contact_type | Обязательно | Строка | 'phone', 'email' | — |
| contact_value | Обязательно | Строка | Уникальный в рамках типа | — |
...
| Параметр | Обязательность | Тип | Ограничение | Значение по умолчанию |
|----------|----------------|-----|-------------|----------------------|
| contact_value | Не обязательно | Строка | Уникальный в рамках типа | — |
